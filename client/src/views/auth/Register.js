...
// ** Reactstrap Imports
import { Row, Col, CardTitle, CardText, Form, Label, Input, Button, InputGroupText, InputGroup } from 'reactstrap'
    ...
    <div className='auth-wrapper auth-cover'>
      <Row className='auth-inner m-0'>
        <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
          ...
          <h2 className='brand-text text-primary ms-1 mt-1'>{themeConfig.app.appName}</h2>
        </Link>
